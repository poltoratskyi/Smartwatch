$(document).ready((function(){const t=[{id:0,dataModal:"runners",pictureWeb:"assets/img/Webp/pulsometr-min-1.webp",pictureJpg:"assets/img/pulsometr-min-1.jpg",label:"Пульсометр Polar FT1",descr:"Спортивные часы для бега с встроенным GPS и функцией мониторинга сердечного ритма помогут вам контролировать тренировки и повысить эффективность вашего бега.",isDiscountPrice:!0,price:130,discountPrice:100},{id:1,dataModal:"proffessional",pictureWeb:"assets/img/Webp/pulsometr-min-2.webp",pictureJpg:"assets/img/pulsometr-min-2.jpg",label:"Пульсометр Suunto M1",descr:"Спортивные часы для единоборств с функцией отслеживания ударов и времени раундов помогут вам повысить эффективность вашей тренировки и контролировать ваш прогресс.",isDiscountPrice:!1,price:180,discountPrice:140},{id:2,dataModal:"runners",pictureWeb:"assets/img/Webp/pulsometr-min-3.webp",pictureJpg:"assets/img/pulsometr-min-3.jpg",label:"Пульсометр Polar FT2",descr:"Водонепроницаемые спортивные часы для плавания с функцией отслеживания дистанции и темпа обеспечат вам точную информацию о вашей тренировке в воде.",isDiscountPrice:!0,price:150,discountPrice:130},{id:3,dataModal:"runners",pictureWeb:"assets/img/Webp/pulsometr-min-4.webp",pictureJpg:"assets/img/pulsometr-min-4.jpg",label:"Пульсометр Polar FT3",descr:"Спортивные часы для горных лыж с высотомером и функцией отслеживания скорости спуска помогут вам максимально использовать каждый спуск и улучшить вашу технику",isDiscountPrice:!1,price:170,discountPrice:150},{id:4,dataModal:"proffessional",pictureWeb:"assets/img/Webp/pulsometr-min-5.webp",pictureJpg:"assets/img/pulsometr-min-5.jpg",label:"Пульсометр Suunto M2",descr:"Спортивные часы для гольфа с функцией определения поля и отслеживания расстояния до лунков помогут вам улучшить вашу игру на поле.",isDiscountPrice:!0,price:200,discountPrice:170},{id:5,dataModal:"runners",pictureWeb:"assets/img/Webp/pulsometr-min-6.webp",pictureJpg:"assets/img/pulsometr-min-6.jpg",label:"Пульсометр Polar FT4",descr:"Универсальные спортивные часы для тренировок в зале с функцией мониторинга сердечного ритма и счетчиком повторений помогут вам достичь ваших целей фитнеса.",isDiscountPrice:!1,price:230,discountPrice:200}];$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("input[name=phone]").mask("+380(99) 999 99 99",{autoclear:!1}),(new WOW).init(),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()}));const e=$(".hamburger"),n=$(".mobile-menu");let s=!1;$(e).on("click",(function(){$(this).toggleClass("hamburger_active"),$(this).hasClass("hamburger_active")?($(n).slideDown(500),s=!0,m.css("transform","rotate(315deg)")):($(n).slideUp(500),s=!1),s?(document.body.style.overflow="hidden",$(i).slideUp(0)):document.body.style.overflow="auto"}));const a=$(".header__content-dropdown"),o=$(".header__content-dropdown-item-link"),i=$(".mobile-menu-dropdown"),c=$(".mobile-menu-dropdown-item-link"),l=$(".header__content-menu-item"),r=$(".mobile-menu-item"),d=(t,e)=>{t.on("click",(function(){const t=$(this).find(e);t.is(":visible")?(t.slideUp(500),m.css("transform","rotate(315deg)")):(t.slideDown(500),m.css("transform","rotate(135deg)"))}))};d(l,a),d(r,i);const u=$(".footer__mobile-info-sidebar-title"),p=$(".footer__mobile-info-sidebar-lists"),m=$(".more-arrow-down");u.on("click",(function(){const t=$(this).siblings(p),e=$(this).find(m);t.is(":visible")?(t.slideUp(500),e.css("transform","rotate(315deg)")):(t.slideDown(500),e.css("transform","rotate(135deg)"))}));const _=$(".header__content-menu-item-link"),b=$(".mobile-menu-item-link"),g=(t,s)=>{t.each((function(){$(this).on("click",(function(t){$(s).slideUp(500),m.css("transform","rotate(315deg)"),$(n).slideUp(500),$(e).removeClass("hamburger_active"),document.body.style.overflow="auto"}))}))};g(_,a),g(b,i);const f=(t,s)=>{$(t).on("click",(function(t){const a=$(this).closest(s);a.is(":visible")&&(m.css("transform","rotate(315deg)"),a.slideUp(500),$(n).slideUp(500),$(e).removeClass("hamburger_active"),document.body.style.overflow="auto")}))};f(o,a),f(c,i);const k=$(".modal-callback__close"),h=$(".modal-overlay"),v=$(".short-window__close"),y=$(".short-window");$("[data-modal=consultation]").on("click",(function(){$(h).fadeIn(500),document.body.style.overflow="hidden"}));const w=(t,e)=>{t.on("click",(function(){$(e).fadeOut(500),document.body.style.overflow="auto"}))};w(k,h),w(v,y),$(document).on("keydown",(function(t){"Escape"===t.key&&($(h).fadeOut(500),$(I).fadeOut(500),$(y).fadeOut(500),$(x).removeClass("basket_active"),document.body.style.overflow="auto")})),$.validator.addMethod("cyrillic",(function(t,e){return this.optional(e)||/^[а-яА-ЯёЁ]+$/i.test(t)}),"Пожалуйста, введите только кириллические символы"),$.validator.addMethod("numberUA",(function(t,e){return this.optional(e)||/^\+380\((?:50|66|95|99|63|67|68|96|97|98|39|73|93)\) \d{3} \d{2} \d{2}$/i.test(t)}),"Пожалуйста, введите корректный номер телефона в формате +380(XX) XXX XX XX"),$.validator.addMethod("emailPublic",(function(t,e){return this.optional(e)||/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(t)}),"Пожалуйста, введите корректный Email"),jQuery.validator.setDefaults({success:"valid"});const P=t=>{$(t).validate({rules:{name:{required:!0,minlength:2,cyrillic:!0},phone:{required:!0,numberUA:!0},email:{required:!0,email:!0}},messages:{name:{required:"Пожалуйста, введите ваше имя",minlength:"Имя должно быть не короче двух символов"},phone:{required:"Пожалуйста, введите ваш номер телефона"},email:{required:"Пожалуйста, введите ваш Email",email:"Пожалуйста, введите корректный Email"}},submitHandler:function(t,e){e.preventDefault(),$(t).find('input[type="text"], input[type="tel"], input[type="email"]').val(""),$(h).fadeOut(500),$(y).fadeIn(500),document.body.style.overflow="auto",setTimeout((()=>{$(y).fadeOut(500)}),6e3)}})};P("#callbackForm"),P("#consultationForm");(t=>{t.click((function(){var t=$($(this).attr("href"));if(t.length)return $("html, body").animate({scrollTop:t.offset().top+"px"},{duration:500,easing:"swing"}),!1}))})($(".header__content-menu-item-link, .header__content-logo-link, .header__content-dropdown-item-link, .mobile-menu-item-link, .mobile-menu-dropdown-item-link, .scroll__to-up, .header__consultation-link, #order-link, .main-logo__link"));(e=>{t.forEach((function(t){const n=`<li\n            data-id="${t.id}"\n            data-modal="${t.dataModal}"\n\t\t\tdata-discount="${t.isDiscountPrice}"\n            class="catalog__content wow fadeInUp"\n          >\n            <picture class="catalog__content-img">\n              <source\n                srcset="${t.pictureWeb}"\n                type="image/webp"\n              />\n\n              <img\n                class="catalog__content-icon"\n                src="${t.pictureWeb}"\n                alt="pulsometr"\n              />\n            </picture>\n\n            <span class="catalog__content-label">${t.label}</span>\n\n            <p class="catalog__content-description">\n\t\t\t${t.descr}\n            </p>\n\n            <a class="catalog__content-link" href="">ПОДРОБНЕЕ</a>\n\n            <span class="catalog__content-line"></span>\n\n            <div class="catalog__content-wrapper-price">\n\n\t\t\t${t.isDiscountPrice?`<span class="catalog__content-discount-price">${t.discountPrice} $</span>\n\t\t\t\t<span class="catalog__content-price">${t.price} $</span>`:`<span class="catalog__content-default-price">${t.price} $</span>`}\n\n              <button\n                class="button button_catalog"\n                data-modal="append"\n                type="button"\n              >\n                Добавить в корзину\n              </button>\n            </div>\n        </li>`;e.prepend(n)}))})($(".catalog__wrapper")),$(".catalog__tab").each((function(){$(this).on("click",(function(){$(this).hasClass("catalog__tab_active")||($(".catalog__tab").removeClass("catalog__tab_active"),$(this).addClass("catalog__tab_active"));const t=$("[data-modal=proffessional]"),e=$("[data-modal=runners]"),n=(t,e,n)=>{"fitness"===$(this).attr("id")&&(n.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),n.removeClass("catalog__content_hidden")}),100)),$(this).attr("id")===t&&(n.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),n.addClass("catalog__content_hidden")}),100))};n("",e,t),n("runners",e,t),n("proffessional",t,e)}))}));const x=$(".basket"),C=$(".basket__items"),I=$(".basket-overlay"),W=$(".basket__title-close"),D=$("#header-basket"),M=$(".header__content-basket-descr"),O=$(".basket__bottom-total-price-value");let S=0,U=JSON.parse(localStorage.getItem("selectedProducts"))||[];const T=(t,e,n)=>{0===U.length&&($(t).css("display","flex"),$(e).css("display","none"),$(n).text("За покупками"),C.css("overflow-y","hidden"))},J=t=>{t.on("click",(function(){$(I).fadeIn(500),$(x).addClass("basket_active"),document.body.style.overflow="hidden"}))};J(D);const N=t=>{$(t).on("click",(function(){$(I).fadeOut(500),$(x).removeClass("basket_active"),document.body.style.overflow="auto"}))};N($("#order-link")),N(W);const X=t=>{$(".basket__item-del").on("click",(function(){const e=$(this).closest(".basket__item").data("id");U.some((t=>t.productId===e))||t.closest(".catalog__content").find("[data-modal='append']").removeClass("button_catalog_active").text("Добавить в корзину")}))},j=()=>{$(".basket__item-del").on("click",(function(){const t=$(this).closest(".basket__item").attr("data-id");U=U.filter((e=>Number(e.productId)!==Number(t))),localStorage.setItem("selectedProducts",JSON.stringify(U)),q(),$(this).closest(".basket__item").slideUp(250),T($(".basket__items-empty"),$("#order"),$("#order-link"))}))};U.forEach((function(t){const e=`\n    <li data-id=${t.productId} class="basket__item">\n        <picture class="basket__item-img">\n            <source\n                srcset="${t.productImgWebP}"\n                type="image/webp"\n            />\n\n            <img\n                class="basket__item-icon"\n                src="${t.productImg}"\n                alt="pulsometr"\n            />\n        </picture>\n\n        <div class="basket__item-info">\n            <span class="basket__item-info-name">\n                    ${t.productName} \n            </span> \n\n            <span class="basket__item-info-availability">\n              В наличии \n            </span> \n\n            <div class="basket__item-info-wrapper">\n                <span class="basket__item-info-value">\n                    ${t.valueCounter} х\n                </span>\n\n                <span class="basket__item-info-price">\n\t\t\t\t\t${t.totalPrice+" $"}\n                </span>\n            </div>\n        </div>\n\n        <span class="basket__item-del">\n            &#x2715; \n        </span> \n    </li>`;C.prepend(e);const n=$(`.catalog__content[data-id="${t.productId}"]`).find("[data-modal='append']");X(n),$(".basket__items-empty").css("display","none")})),T($(".basket__items-empty"),$("#order"),$("#order-link"));const q=()=>{S=U.reduce(((t,e)=>t+e.totalPrice),0),0===S?(M.text("Корзина"),O.text("0 $")):(M.text(`${S} $`),O.text(`${S} $`))};$("[data-modal='append']").each((function(){const t=$(this);(t=>{const e=t.closest(".catalog__content").attr("data-id");U.some((t=>t.productId===e))&&t.addClass("button_catalog_active").text("В корзине")})(t),q(),J(t),t.on("click",(function(){C.css("overflow-y","auto");const e=t.closest(".catalog__content").attr("data-id"),n=t.closest(".catalog__content").data("modal"),s=t.closest(".catalog__content").data("discount"),a=t.closest(".catalog__content").find(".catalog__content-img img").attr("src"),o=t.closest(".catalog__content").find(".catalog__content-img source").attr("srcset"),i=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-label").text(),c=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-description").text().trim(),l=parseInt(t.siblings(".catalog__content-default-price").text()),r=parseInt(t.siblings(".catalog__content-discount-price").text());if(!U.some((t=>Number(t.productId)===Number(e)))){t.addClass("button_catalog_active").text("В корзине");const d=r||l;S+=d,M.text(`${S} $`),O.text(`${S} $`),U.push({dataModal:n,productId:e,isDiscountPrice:s,productImg:a,productImgWebP:o,productName:i,productDescr:c,productPrice:r,productDefaultPrice:l,totalPrice:d,valueCounter:1}),localStorage.setItem("selectedProducts",JSON.stringify(U)),E(e,a,o,i,r,d,1),j(),$(".basket__items-empty").css("display","none"),$("#order").css("display","block"),$("#order-link").text("Добавить другие товары"),X(t)}}))})),j();const E=(t,e,n,s,a,o,i)=>{let c=`\n    <li data-id=${t} class="basket__item">\n        <picture class="basket__item-img">\n            <source\n                srcset="${n}"\n                type="image/webp"\n            />\n\n            <img\n                class="basket__item-icon"\n                src="${e}"\n                alt="pulsometr"\n            />\n        </picture>\n\n        <div class="basket__item-info">\n            <span class="basket__item-info-name">\n                    ${s} \n            </span> \n\n            <span class="basket__item-info-availability">\n              В наличии \n            </span> \n\n            <div class="basket__item-info-wrapper">\n                <span class="basket__item-info-value">\n                    ${i} х\n                </span>\n\n                <span class="basket__item-info-price">\n\t\t\t\t\t${a?a+" $":o+" $"}\n                </span>\n            </div>\n        </div>\n\n        <span class="basket__item-del">\n            &#x2715; \n        </span> \n    </li>`;C.prepend(c)}}));
