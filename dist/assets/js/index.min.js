$(document).ready((function(){$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1}),(new WOW).init();const e=$(".hamburger");$(e).on("click",(function(){$(this).toggleClass("hamburger_active"),$(".header__content-menu").toggleClass("header__content-menu_active"),$(".header__content-menu").hasClass("header__content-menu_active")?($(t).css("background-color","rgba(0, 0, 0, 0.7)"),document.body.style.overflow="hidden"):document.body.style.overflow="auto"})),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()}));const t=$(".decor"),o=$(".header__content-dropdown"),n=$(".header__content-dropdown-item-link");let a=!1;$(t).mouseenter((function(){!1===a&&$(this).css("background-color","rgba(0, 0, 0, 1)")})),$(t).mouseleave((function(){!1===a&&$(this).css("background-color","rgba(0, 0, 0, 0.7)")})),$(".header__content-menu-item").on("click",(function(){const e=$(this).find(o);return e.is(":visible")?(e.slideUp(),a=!1):$(".header__content-menu").hasClass("header__content-menu_active")?($(t).css("background-color","rgba(0, 0, 0, 0.7)"),e.slideDown(),a=!0):($(t).css("background-color","rgba(0, 0, 0, 1)"),$(o).css("background-color","rgba(0, 0, 0, 1)"),e.slideDown(),a=!0),a})),$(".header__content-menu-item-link").each((function(){$(this).on("click",(function(t){t.preventDefault(),$(o).slideUp(),$(".header__content-menu").hasClass("header__content-menu_active")&&($(e).removeClass("hamburger_active"),$(".header__content-menu").removeClass("header__content-menu_active"),document.body.style.overflow="auto")}))})),$(n).on("click",(function(t){t.preventDefault();const n=$(this).closest(o);return n.is(":visible")&&(n.slideUp(),a=!1,$(e).removeClass("hamburger_active"),$(".header__content-menu").removeClass("header__content-menu_active"),document.body.style.overflow="auto"),a}));const s=$(".modal-callback__close"),c=$(".overlay"),l=$(".success__close"),i=$(".success");$("[data-modal=consultation]").on("click",(function(e){e.preventDefault(),$(c).fadeIn("slow"),document.body.style.overflow="hidden"}));const d=(e,t)=>{e.on("click",(function(e){e.preventDefault(),$(t).fadeOut("slow"),document.body.style.overflow="auto"}))};d(s,c),d(l,i),$(document).on("keydown",(function(e){"Escape"===e.key&&($(c).fadeOut("slow"),$(i).fadeOut("slow"),document.body.style.overflow="auto")})),$(".consultation__form, .modal-callback__form").submit((function(e){e.preventDefault();let t=!0,o=$(this).find(".consultation__form-input, .modal-callback__form-input");o.each((function(){if(!this.checkValidity())return t=!1,!1})),t&&(o.val(""),$(c).fadeOut("slow"),$(i).fadeIn("slow"),document.body.style.overflow="auto",setTimeout((()=>{$(i).fadeOut("slow")}),6e3))})),$(".header__content-menu-item-link, .header__content-logo, .header__content-dropdown-item-link, .scroll__to-up, .header__consultation-link").click((function(){var e=$($(this).attr("href"));if(e.length)return $("html, body").animate({scrollTop:e.offset().top+"px"},{duration:500,easing:"swing"}),!1})),$(".catalog__tab").each((function(){$(this).on("click",(function(){$(this).hasClass("catalog__tab_active")||($(".catalog__tab").removeClass("catalog__tab_active"),$(this).addClass("catalog__tab_active"));const e=$("[data-modal=proffessional]"),t=$("[data-modal=runners]"),o=(e,t,o)=>{"fitness"===$(this).attr("id")&&(o.addClass("catalog__content_hidden"),t.addClass("catalog__content_hidden"),setTimeout((()=>{t.removeClass("catalog__content_hidden"),o.removeClass("catalog__content_hidden")}),100)),$(this).attr("id")===e&&(o.addClass("catalog__content_hidden"),t.addClass("catalog__content_hidden"),setTimeout((()=>{t.removeClass("catalog__content_hidden"),o.addClass("catalog__content_hidden")}),100))};o("",t,e),o("runners",t,e),o("proffessional",e,t)}))}))}));
