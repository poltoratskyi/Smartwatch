$(document).ready((function(){$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1}),(new WOW).init(),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()}));const t=$(".hamburger"),e=$(".mobile-menu");let o=!1;$(t).on("click",(function(){$(this).toggleClass("hamburger_active"),$(this).hasClass("hamburger_active")?($(e).slideDown(500),o=!0):($(e).slideUp(500),o=!1),o?(document.body.style.overflow="hidden",$(s).slideUp(0)):document.body.style.overflow="auto"}));const n=$(".header__content-dropdown"),a=$(".header__content-dropdown-item-link"),s=$(".mobile-menu-dropdown"),l=$(".mobile-menu-dropdown-item-link"),i=$(".header__content-menu-item"),c=$(".mobile-menu-item"),d=(t,e)=>{t.on("click",(function(){const t=$(this).find(e);t.is(":visible")?t.slideUp(500):t.slideDown()}))};d(i,n),d(c,s);const r=$(".header__content-menu-item-link"),u=$(".mobile-menu-item-link"),_=(o,n)=>{o.each((function(){$(this).on("click",(function(o){o.preventDefault(),$(n).slideUp(500),$(e).slideUp(500),$(t).removeClass("hamburger_active"),document.body.style.overflow="auto"}))}))};_(r,n),_(u,s);const m=(o,n)=>{$(o).on("click",(function(o){o.preventDefault();const a=$(this).closest(n);a.is(":visible")&&(a.slideUp(500),$(e).slideUp(500),$(t).removeClass("hamburger_active"),document.body.style.overflow="auto")}))};m(a,n),m(l,s);const f=$(".modal-callback__close"),h=$(".modal-overlay"),b=$(".success__close"),p=$(".success");$("[data-modal=consultation]").on("click",(function(t){t.preventDefault(),$(h).fadeIn(500),document.body.style.overflow="hidden"}));const v=(t,e)=>{t.on("click",(function(t){t.preventDefault(),$(e).fadeOut(500),document.body.style.overflow="auto"}))};v(f,h),v(b,p),$(document).on("keydown",(function(t){"Escape"===t.key&&($(h).fadeOut(500),$(g).fadeOut(500),$(p).fadeOut(500),document.body.style.overflow="auto")})),$(".consultation__form, .modal-callback__form").submit((function(t){t.preventDefault();let e=!0,o=$(this).find(".consultation__form-input, .modal-callback__form-input");o.each((function(){if(!this.checkValidity())return e=!1,!1})),e&&(o.val(""),$(h).fadeOut(500),$(p).fadeIn(500),document.body.style.overflow="auto",setTimeout((()=>{$(p).fadeOut(500)}),6e3))})),$(".header__content-menu-item-link, .header__content-logo-link, .header__content-dropdown-item-link, .mobile-menu-item-link, .mobile-menu-dropdown-item-link, .scroll__to-up, .header__consultation-link").click((function(){var t=$($(this).attr("href"));if(t.length)return $("html, body").animate({scrollTop:t.offset().top+"px"},{duration:500,easing:"swing"}),!1})),$(".catalog__tab").each((function(){$(this).on("click",(function(){$(this).hasClass("catalog__tab_active")||($(".catalog__tab").removeClass("catalog__tab_active"),$(this).addClass("catalog__tab_active"));const t=$("[data-modal=proffessional]"),e=$("[data-modal=runners]"),o=(t,e,o)=>{"fitness"===$(this).attr("id")&&(o.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),o.removeClass("catalog__content_hidden")}),100)),$(this).attr("id")===t&&(o.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),o.addClass("catalog__content_hidden")}),100))};o("",e,t),o("runners",e,t),o("proffessional",t,e)}))}));const g=$(".basket-overlay"),k=$(".basket__title-close");let y=0;$("[data-modal='append']").each((function(){$(this).on("click",(function(){$(this).closest(".catalog__content-wrapper-price").siblings(".catalog__content-label");const t=parseFloat($(this).siblings(".catalog__content-default-price").text()),e=parseFloat($(this).siblings(".catalog__content-discount-price").text());y+=e||t,$(".header__content-basket-descr").text(`${y} $`),$(this).off("click"),$(this).addClass("button_catalog_active").text("В корзине"),$(this).on("click",(function(){$(g).fadeIn(500),document.body.style.overflow="hidden"})),w($(k))}))})),$("#header-basket").on("click",(function(){document.body.style.overflow="hidden",$(g).fadeIn(500),w($(k))}));const w=t=>{$(t).on("click",(function(){document.body.style.overflow="auto",$(g).fadeOut(500)}))};w(btn_order)}));
