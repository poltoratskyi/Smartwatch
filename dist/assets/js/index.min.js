$(document).ready((function(){$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1}),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()})),$(".scroll__to-up, .header__consultation-link").click((function(){return $("html, body").animate({scrollTop:$($(this).attr("href")).offset().top+"px"},{duration:500,easing:"swing"}),!1}))}));
