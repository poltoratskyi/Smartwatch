$(document).ready((function(){$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1}),(new WOW).init(),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()}));const t=$(".hamburger"),e=$(".mobile-menu");let n=!1;$(t).on("click",(function(){$(this).toggleClass("hamburger_active"),$(this).hasClass("hamburger_active")?($(e).slideDown(500),n=!0):($(e).slideUp(500),n=!1),n?(document.body.style.overflow="hidden",$(s).slideUp(0)):document.body.style.overflow="auto"}));const o=$(".header__content-dropdown"),a=$(".header__content-dropdown-item-link"),s=$(".mobile-menu-dropdown"),i=$(".mobile-menu-dropdown-item-link"),c=$(".header__content-menu-item"),l=$(".mobile-menu-item"),d=(t,e)=>{t.on("click",(function(){const t=$(this).find(e);t.is(":visible")?t.slideUp(500):t.slideDown()}))};d(c,o),d(l,s);const r=$(".header__content-menu-item-link"),_=$(".mobile-menu-item-link"),u=(n,o)=>{n.each((function(){$(this).on("click",(function(n){n.preventDefault(),$(o).slideUp(500),$(e).slideUp(500),$(t).removeClass("hamburger_active"),document.body.style.overflow="auto"}))}))};u(r,o),u(_,s);const m=(n,o)=>{$(n).on("click",(function(n){n.preventDefault();const a=$(this).closest(o);a.is(":visible")&&(a.slideUp(500),$(e).slideUp(500),$(t).removeClass("hamburger_active"),document.body.style.overflow="auto")}))};m(a,o),m(i,s);const p=$(".modal-callback__close"),b=$(".modal-overlay"),f=$(".success__close"),k=$(".success");$("[data-modal=consultation]").on("click",(function(t){t.preventDefault(),$(b).fadeIn(500),document.body.style.overflow="hidden"}));const v=(t,e)=>{t.on("click",(function(t){t.preventDefault(),$(e).fadeOut(500),document.body.style.overflow="auto"}))};v(p,b),v(f,k),$(document).on("keydown",(function(t){"Escape"===t.key&&($(b).fadeOut(500),$(y).fadeOut(500),$(k).fadeOut(500),$(g).removeClass("basket_active"),document.body.style.overflow="auto")})),$(".consultation__form, .modal-callback__form").submit((function(t){t.preventDefault();let e=!0,n=$(this).find(".consultation__form-input, .modal-callback__form-input");n.each((function(){if(!this.checkValidity())return e=!1,!1})),e&&(n.val(""),$(b).fadeOut(500),$(k).fadeIn(500),document.body.style.overflow="auto",setTimeout((()=>{$(k).fadeOut(500)}),6e3))}));$(".header__content-menu-item-link, .header__content-logo-link, .header__content-dropdown-item-link, .mobile-menu-item-link, .mobile-menu-dropdown-item-link, .scroll__to-up, .header__consultation-link, #order-link").click((function(){var t=$($(this).attr("href"));if(t.length)return $("html, body").animate({scrollTop:t.offset().top+"px"},{duration:500,easing:"swing"}),!1})),$(".catalog__tab").each((function(){$(this).on("click",(function(){$(this).hasClass("catalog__tab_active")||($(".catalog__tab").removeClass("catalog__tab_active"),$(this).addClass("catalog__tab_active"));const t=$("[data-modal=proffessional]"),e=$("[data-modal=runners]"),n=(t,e,n)=>{"fitness"===$(this).attr("id")&&(n.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),n.removeClass("catalog__content_hidden")}),100)),$(this).attr("id")===t&&(n.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),n.addClass("catalog__content_hidden")}),100))};n("",e,t),n("runners",e,t),n("proffessional",t,e)}))}));const g=$(".basket"),h=$(".basket__items"),y=$(".basket-overlay"),w=$(".basket__title-close"),C=$("#header-basket"),I=$(".header__content-basket-descr"),x=$(".basket__bottom-total-price-value"),O=$("#order-link");let D=0,N=JSON.parse(localStorage.getItem("selectedProducts"))||[];const S=t=>{t.on("click",(function(){$(y).fadeIn(500),$(g).addClass("basket_active"),document.body.style.overflow="hidden"}))};S(C);const T=t=>{$(t).on("click",(function(){$(y).fadeOut(500),$(g).removeClass("basket_active"),document.body.style.overflow="auto"}))};T(O),T(w);$(".basket__item-info-value"),$(".basket__item-info-counter-plus"),$(".basket__item-info-counter-minus");const U=t=>{$(".basket__item-del").on("click",(function(){const e=$(this).closest(".basket__item").data("id");N.some((t=>t.productId===e))||t.closest(".catalog__content").find("[data-modal='append']").removeClass("button_catalog_active").text("Добавить в корзину")}))},P=()=>{$(".basket__item-del").on("click",(function(){const t=$(this).closest(".basket__item").attr("data-id");N=N.filter((e=>Number(e.productId)!==Number(t))),localStorage.setItem("selectedProducts",JSON.stringify(N)),J(),$(this).closest(".basket__item").animate({opacity:0,marginTop:"-180px"},200,(function(){$(this).remove()}))}))};N.forEach((function(t){const e=`<li data-id=${t.productId} class="basket__item">\n      <picture class="basket__item-img">\n        <source\n          srcset="${t.productImg}"\n          type="image/webp"\n        />\n\n        <img\n          class="basket__item-icon"\n          src="${t.productImg}"\n          loading="lazy"\n          alt="pulsometr"\n        />\n      </picture>\n\n      <div class="basket__item-info">\n        <div class="basket__item-del">&times;</div>\n\n        <p class="basket__item-info-name">${t.productName}</p>\n\n        <p class="basket__item-info-descr">\n          ${t.productDescr}\n        </p>\n\n        <div class="basket__item-info-wrapper">\n          <div class="basket__item-info-counter">\n            <span class="basket__item-info-counter-minus">-</span>\n            <span class="basket__item-info-value">${t.valueCounter}</span>\n            <span class="basket__item-info-counter-plus">+</span>\n          </div>\n\n          <span class="basket__item-info-price">${t.totalPrice} $</span>\n        </div>\n      </div>\n    </li>`;h.prepend(e);const n=$(`.catalog__content[data-id="${t.productId}"]`).find("[data-modal='append']");U(n)}));const J=()=>{D=N.reduce(((t,e)=>t+e.totalPrice),0),0===D?(I.text("Корзина"),x.text("0 $")):(I.text(`${D} $`),x.text(`${D} $`))};$("[data-modal='append']").each((function(){const t=$(this);(t=>{const e=t.closest(".catalog__content").attr("data-id");N.some((t=>t.productId===e))&&t.addClass("button_catalog_active").text("В корзине")})(t),J(),S(t),t.on("click",(function(){const e=t.closest(".catalog__content").attr("data-id");if(!N.some((t=>Number(t.productId)===Number(e)))){const e=t.closest(".catalog__content").attr("data-id"),n=t.closest(".catalog__content").find(".catalog__content-img img").attr("src"),o=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-label").text(),a=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-description").text().trim(),s=parseInt(t.siblings(".catalog__content-default-price").text()),i=parseInt(t.siblings(".catalog__content-discount-price").text())||s;D+=i,I.text(`${D} $`),x.text(`${D} $`),t.addClass("button_catalog_active").text("В корзине"),N.push({productId:e,productImg:n,productName:o,productDescr:a,totalPrice:i,valueCounter:1}),localStorage.setItem("selectedProducts",JSON.stringify(N));const c=`<li data-id=${e} class="basket__item">\n          <picture class="basket__item-img">\n            <source\n              srcset="${n}"\n              type="image/webp"\n            />\n\n            <img\n              class="basket__item-icon"\n              src="${n}"\n              loading="lazy"\n              alt="pulsometr"\n            />\n          </picture>\n\n          <div class="basket__item-info">\n            <div class="basket__item-del">&times;</div>\n\n            <p class="basket__item-info-name">${o}</p>\n\n            <p class="basket__item-info-descr">\n              ${a}\n            </p>\n\n            <div class="basket__item-info-wrapper">\n              <div class="basket__item-info-counter">\n                <span class="basket__item-info-counter-minus">-</span>\n                <span class="basket__item-info-value">1</span>\n                <span class="basket__item-info-counter-plus">+</span>\n              </div>\n\n              <span class="basket__item-info-price">${i} $</span>\n            </div>\n          </div>\n        </li>`;h.prepend(c),S(t),P(),U(t)}}))})),P()}));
