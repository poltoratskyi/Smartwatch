$(document).ready((function(){$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1}),(new WOW).init(),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()}));const t=$(".hamburger"),e=$(".mobile-menu");let o=!1;$(t).on("click",(function(){$(this).toggleClass("hamburger_active"),$(this).hasClass("hamburger_active")?($(e).slideDown(500),o=!0):($(e).slideUp(500),o=!1),o?(document.body.style.overflow="hidden",$(s).slideUp(0)):document.body.style.overflow="auto"}));const n=$(".header__content-dropdown"),a=$(".header__content-dropdown-item-link"),s=$(".mobile-menu-dropdown"),c=$(".mobile-menu-dropdown-item-link"),l=$(".header__content-menu-item"),i=$(".mobile-menu-item"),d=(t,e)=>{t.on("click",(function(){const t=$(this).find(e);t.is(":visible")?t.slideUp(500):t.slideDown()}))};d(l,n),d(i,s);const r=$(".header__content-menu-item-link"),_=$(".mobile-menu-item-link"),u=(o,n)=>{o.each((function(){$(this).on("click",(function(o){o.preventDefault(),$(n).slideUp(500),$(e).slideUp(500),$(t).removeClass("hamburger_active"),document.body.style.overflow="auto"}))}))};u(r,n),u(_,s);const m=(o,n)=>{$(o).on("click",(function(o){o.preventDefault();const a=$(this).closest(n);a.is(":visible")&&(a.slideUp(500),$(e).slideUp(500),$(t).removeClass("hamburger_active"),document.body.style.overflow="auto")}))};m(a,n),m(c,s);const f=$(".modal-callback__close"),p=$(".modal-overlay"),b=$(".success__close"),h=$(".success");$("[data-modal=consultation]").on("click",(function(t){t.preventDefault(),$(p).fadeIn(500),document.body.style.overflow="hidden"}));const g=(t,e)=>{t.on("click",(function(t){t.preventDefault(),$(e).fadeOut(500),document.body.style.overflow="auto"}))};g(f,p),g(b,h),$(document).on("keydown",(function(t){"Escape"===t.key&&($(p).fadeOut(500),$(k).fadeOut(500),$(h).fadeOut(500),$(v).removeClass("basket_active"),document.body.style.overflow="auto")})),$(".consultation__form, .modal-callback__form").submit((function(t){t.preventDefault();let e=!0,o=$(this).find(".consultation__form-input, .modal-callback__form-input");o.each((function(){if(!this.checkValidity())return e=!1,!1})),e&&(o.val(""),$(p).fadeOut(500),$(h).fadeIn(500),document.body.style.overflow="auto",setTimeout((()=>{$(h).fadeOut(500)}),6e3))}));$(".header__content-menu-item-link, .header__content-logo-link, .header__content-dropdown-item-link, .mobile-menu-item-link, .mobile-menu-dropdown-item-link, .scroll__to-up, .header__consultation-link, #order-link").click((function(){var t=$($(this).attr("href"));if(t.length)return $("html, body").animate({scrollTop:t.offset().top+"px"},{duration:500,easing:"swing"}),!1})),$(".catalog__tab").each((function(){$(this).on("click",(function(){$(this).hasClass("catalog__tab_active")||($(".catalog__tab").removeClass("catalog__tab_active"),$(this).addClass("catalog__tab_active"));const t=$("[data-modal=proffessional]"),e=$("[data-modal=runners]"),o=(t,e,o)=>{"fitness"===$(this).attr("id")&&(o.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),o.removeClass("catalog__content_hidden")}),100)),$(this).attr("id")===t&&(o.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),o.addClass("catalog__content_hidden")}),100))};o("",e,t),o("runners",e,t),o("proffessional",t,e)}))}));const v=$(".basket"),k=$(".basket-overlay"),y=$(".basket__title-close"),w=$("#header-basket"),C=$(".header__content-basket-descr"),x=$(".basket__bottom-total-price-value"),O=$("#order-link");let D=0,S=JSON.parse(localStorage.getItem("selectedProducts"))||[];const T=t=>{t.on("click",(function(){$(k).fadeIn(500),$(v).addClass("basket_active"),document.body.style.overflow="hidden"}))};T(w);const U=t=>{$(t).on("click",(function(){$(k).fadeOut(500),$(v).removeClass("basket_active"),document.body.style.overflow="auto"}))};U(O),U(y);$("[data-modal='append']").each((function(){const t=$(this);(t=>{const e=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-label").text();S.some((t=>t.productName===e))&&t.addClass("button_catalog_active").text("В корзине")})(t),D=S.reduce(((t,e)=>t+e.totalPrice),0),0===D?(C.text("Корзина"),x.text("0 $")):(C.text(`${D} $`),x.text(`${D} $`));const e=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-label").text();S.some((t=>t.productName===e))||(T(t),t.on("click",(function(){const e=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-label").text(),o=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-description").text().trim(),n=parseFloat(t.siblings(".catalog__content-default-price").text()),a=parseFloat(t.siblings(".catalog__content-discount-price").text())||n;D+=a,C.text(`${D} $`),x.text(`${D} $`),t.addClass("button_catalog_active").text("В корзине"),S.push({productName:e,productDescr:o,totalPrice:a}),localStorage.setItem("selectedProducts",JSON.stringify(S)),t.off("click")})))}))}));
