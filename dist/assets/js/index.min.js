$(document).ready((function(){$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1}),(new WOW).init(),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()}));const e=$(".hamburger"),t=$(".mobile-menu");let o=!1;$(e).on("click",(function(){$(this).toggleClass("hamburger_active"),$(this).hasClass("hamburger_active")?($(t).slideDown(500),o=!0):($(t).slideUp(500),o=!1),o?(document.body.style.overflow="hidden",$(i).slideUp(0)):document.body.style.overflow="auto"}));const n=$(".decor"),s=$(".header__content-dropdown"),a=$(".header__content-dropdown-item-link"),i=$(".mobile-menu-dropdown"),l=$(".mobile-menu-dropdown-item-link");let c=!1;var d;d=n,e.is(":visible")||($(d).mouseenter((function(){!1===c&&$(this).css("background-color","rgba(0, 0, 0, 1)")})),$(d).mouseleave((function(){!1===c&&$(this).css("background-color","rgba(0, 0, 0, 0.7)")})));const r=$(".header__content-menu-item"),u=$(".mobile-menu-item"),_=(e,t)=>{e.on("click",(function(){const e=$(this).find(t);return e.is(":visible")?(e.slideUp(500),c=!1):(e.slideDown(),c=!0),c}))};_(r,s),_(u,i);const m=$(".header__content-menu-item-link"),f=$(".mobile-menu-item-link"),h=(o,n)=>{o.each((function(){$(this).on("click",(function(o){o.preventDefault(),$(n).slideUp(500),$(t).slideUp(500),$(e).removeClass("hamburger_active"),document.body.style.overflow="auto"}))}))};h(m,s),h(f,i);const b=(o,n)=>{$(o).on("click",(function(o){o.preventDefault();const s=$(this).closest(n);return s.is(":visible")&&(s.slideUp(500),$(t).slideUp(500),c=!1,$(e).removeClass("hamburger_active"),document.body.style.overflow="auto"),c}))};b(a,s),b(l,i);const p=$(".modal-callback__close"),v=$(".overlay"),g=$(".success__close"),k=$(".success");$("[data-modal=consultation]").on("click",(function(e){e.preventDefault(),$(v).fadeIn(500),document.body.style.overflow="hidden"}));const y=(e,t)=>{e.on("click",(function(e){e.preventDefault(),$(t).fadeOut(500),document.body.style.overflow="auto"}))};y(p,v),y(g,k),$(document).on("keydown",(function(e){"Escape"===e.key&&($(v).fadeOut(500),$(k).fadeOut(500),document.body.style.overflow="auto")})),$(".consultation__form, .modal-callback__form").submit((function(e){e.preventDefault();let t=!0,o=$(this).find(".consultation__form-input, .modal-callback__form-input");o.each((function(){if(!this.checkValidity())return t=!1,!1})),t&&(o.val(""),$(v).fadeOut(500),$(k).fadeIn(500),document.body.style.overflow="auto",setTimeout((()=>{$(k).fadeOut(500)}),6e3))})),$(".header__content-menu-item-link, .header__content-logo-link, .header__content-dropdown-item-link, .mobile-menu-item-link, .mobile-menu-dropdown-item-link, .scroll__to-up, .header__consultation-link").click((function(){var e=$($(this).attr("href"));if(e.length)return $("html, body").animate({scrollTop:e.offset().top+"px"},{duration:500,easing:"swing"}),!1})),$(".catalog__tab").each((function(){$(this).on("click",(function(){$(this).hasClass("catalog__tab_active")||($(".catalog__tab").removeClass("catalog__tab_active"),$(this).addClass("catalog__tab_active"));const e=$("[data-modal=proffessional]"),t=$("[data-modal=runners]"),o=(e,t,o)=>{"fitness"===$(this).attr("id")&&(o.addClass("catalog__content_hidden"),t.addClass("catalog__content_hidden"),setTimeout((()=>{t.removeClass("catalog__content_hidden"),o.removeClass("catalog__content_hidden")}),100)),$(this).attr("id")===e&&(o.addClass("catalog__content_hidden"),t.addClass("catalog__content_hidden"),setTimeout((()=>{t.removeClass("catalog__content_hidden"),o.addClass("catalog__content_hidden")}),100))};o("",t,e),o("runners",t,e),o("proffessional",e,t)}))}))}));
