$(document).ready((function(){$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("[data-modal=consultation]").on("click",(function(o){o.preventDefault(),$(".overlay").fadeIn("slow")})),$(".consultation__form, .modal-callback__form").submit((function(o){o.preventDefault();let t=!0;$(this).find(".consultation__form-input, .modal-callback__form-input").each((function(){if(!this.checkValidity())return t=!1,!1})),t&&($(".overlay").fadeOut("slow"),$(".consultation__form-input, .modal-callback__form-input").val(""),$(".success").fadeIn("slow"),setTimeout((()=>{$(".success").fadeOut("slow")}),6e3))})),$(".modal-callback__close").on("click",(function(o){o.preventDefault(),$(".overlay").fadeOut("slow")})),$(document).on("keydown",(function(o){"Escape"===o.key&&($(".overlay").fadeOut("slow"),$(".success").fadeOut("slow"))})),$(".success__close").on("click",(function(o){o.preventDefault(),$(".success").fadeOut("slow")})),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1}),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()})),$(".scroll__to-up, .header__consultation-link").click((function(){return $("html, body").animate({scrollTop:$($(this).attr("href")).offset().top+"px"},{duration:500,easing:"swing"}),!1}))}));
