$(document).ready((function(){$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1}),(new WOW).init();const t=$(".modal-callback__close"),o=$(".overlay"),a=$(".success__close"),s=$(".success");$("[data-modal=consultation]").on("click",(function(t){t.preventDefault(),$(o).fadeIn("slow")}));const e=(t,o)=>{t.on("click",(function(t){t.preventDefault(),$(o).fadeOut("slow")}))};e(t,o),e(a,s),$(document).on("keydown",(function(t){"Escape"===t.key&&($(o).fadeOut("slow"),$(s).fadeOut("slow"))})),$(".consultation__form, .modal-callback__form").submit((function(t){t.preventDefault();let a=!0,e=$(this).find(".consultation__form-input, .modal-callback__form-input");e.each((function(){if(!this.checkValidity())return a=!1,!1})),a&&($(o).fadeOut("slow"),e.val(""),$(s).fadeIn("slow"),setTimeout((()=>{$(s).fadeOut("slow")}),6e3))})),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()})),$(".scroll__to-up, .header__consultation-link").click((function(){return $("html, body").animate({scrollTop:$($(this).attr("href")).offset().top+"px"},{duration:500,easing:"swing"}),!1})),$(".catalog__tab").each((function(){$(this).on("click",(function(){$(this).hasClass("catalog__tab_active")||($(".catalog__tab").removeClass("catalog__tab_active"),$(this).addClass("catalog__tab_active"));const t=$("[data-modal=proffessional]"),o=$("[data-modal=runners]"),a=(t,o,a)=>{"beginners"===$(this).attr("id")&&(a.addClass("catalog__content_hidden"),o.addClass("catalog__content_hidden"),setTimeout((()=>{o.removeClass("catalog__content_hidden"),a.removeClass("catalog__content_hidden")}),100)),$(this).attr("id")===t&&(a.addClass("catalog__content_hidden"),o.addClass("catalog__content_hidden"),setTimeout((()=>{o.removeClass("catalog__content_hidden"),a.addClass("catalog__content_hidden")}),100))};a("",o,t),a("runners",o,t),a("proffessional",t,o)}))}))}));
