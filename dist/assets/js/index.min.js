$(document).ready((function(){$(".preloader").fadeOut(500),$(".carousel___content-slider").slick({autoplay:!0,autoplaySpeed:2500,speed:1200,infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,prevArrow:'<button type="button" class="carousel_slick-prev"><img src="assets/icons/left.svg"></button>',nextArrow:'<button type="button" class="carousel_slick-next"><img src="assets/icons/right.svg"></button>',responsive:[{breakpoint:992,settings:{arrows:!1,dots:!0}}]}),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1}),(new WOW).init(),$(window).scroll((function(){$(this).scrollTop()>1600?$(".scroll__to-up").fadeIn():$(".scroll__to-up").fadeOut()}));const t=$(".hamburger"),e=$(".mobile-menu");let n=!1;$(t).on("click",(function(){$(this).toggleClass("hamburger_active"),$(this).hasClass("hamburger_active")?($(e).slideDown(500),n=!0,m.css("transform","rotate(315deg)")):($(e).slideUp(500),n=!1),n?(document.body.style.overflow="hidden",$(a).slideUp(0)):document.body.style.overflow="auto"}));const s=$(".header__content-dropdown"),o=$(".header__content-dropdown-item-link"),a=$(".mobile-menu-dropdown"),i=$(".mobile-menu-dropdown-item-link"),c=$(".header__content-menu-item"),l=$(".mobile-menu-item"),d=(t,e)=>{t.on("click",(function(){const t=$(this).find(e);t.is(":visible")?(t.slideUp(500),m.css("transform","rotate(315deg)")):(t.slideDown(500),m.css("transform","rotate(135deg)"))}))};d(c,s),d(l,a);const r=$(".footer__mobile-info-sidebar-title"),_=$(".footer__mobile-info-sidebar-lists"),m=$(".more-arrow-down");r.on("click",(function(){const t=$(this).siblings(_),e=$(this).find(m);t.is(":visible")?(t.slideUp(500),e.css("transform","rotate(315deg)")):(t.slideDown(500),e.css("transform","rotate(135deg)"))}));const u=$(".header__content-menu-item-link"),p=$(".mobile-menu-item-link"),b=(n,s)=>{n.each((function(){$(this).on("click",(function(n){$(s).slideUp(500),m.css("transform","rotate(315deg)"),$(e).slideUp(500),$(t).removeClass("hamburger_active"),document.body.style.overflow="auto"}))}))};b(u,s),b(p,a);const f=(n,s)=>{$(n).on("click",(function(n){const o=$(this).closest(s);o.is(":visible")&&(m.css("transform","rotate(315deg)"),o.slideUp(500),$(e).slideUp(500),$(t).removeClass("hamburger_active"),document.body.style.overflow="auto")}))};f(o,s),f(i,a);const k=$(".modal-callback__close"),g=$(".modal-overlay"),v=$(".success__close"),h=$(".success");$("[data-modal=consultation]").on("click",(function(){$(g).fadeIn(500),document.body.style.overflow="hidden"}));const y=(t,e)=>{t.on("click",(function(){$(e).fadeOut(500),document.body.style.overflow="auto"}))};y(k,g),y(v,h),$(document).on("keydown",(function(t){"Escape"===t.key&&($(g).fadeOut(500),$(x).fadeOut(500),$(h).fadeOut(500),$(w).removeClass("basket_active"),document.body.style.overflow="auto")})),$(".consultation__form, .modal-callback__form").submit((function(t){t.preventDefault();let e=!0,n=$(this).find(".consultation__form-input, .modal-callback__form-input");n.each((function(){if(!this.checkValidity())return e=!1,!1})),e&&(n.val(""),$(g).fadeOut(500),$(h).fadeIn(500),document.body.style.overflow="auto",setTimeout((()=>{$(h).fadeOut(500)}),6e3))}));(t=>{t.click((function(){var t=$($(this).attr("href"));if(t.length)return $("html, body").animate({scrollTop:t.offset().top+"px"},{duration:500,easing:"swing"}),!1}))})($(".header__content-menu-item-link, .header__content-logo-link, .header__content-dropdown-item-link, .mobile-menu-item-link, .mobile-menu-dropdown-item-link, .scroll__to-up, .header__consultation-link, #order-link, .main-logo__link")),$(".catalog__tab").each((function(){$(this).on("click",(function(){$(this).hasClass("catalog__tab_active")||($(".catalog__tab").removeClass("catalog__tab_active"),$(this).addClass("catalog__tab_active"));const t=$("[data-modal=proffessional]"),e=$("[data-modal=runners]"),n=(t,e,n)=>{"fitness"===$(this).attr("id")&&(n.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),n.removeClass("catalog__content_hidden")}),100)),$(this).attr("id")===t&&(n.addClass("catalog__content_hidden"),e.addClass("catalog__content_hidden"),setTimeout((()=>{e.removeClass("catalog__content_hidden"),n.addClass("catalog__content_hidden")}),100))};n("",e,t),n("runners",e,t),n("proffessional",t,e)}))}));const w=$(".basket"),C=$(".basket__items"),x=$(".basket-overlay"),I=$(".basket__title-close"),O=$("#header-basket"),N=$(".header__content-basket-descr"),S=$(".basket__bottom-total-price-value");let U=0,P=JSON.parse(localStorage.getItem("selectedProducts"))||[];const T=(t,e,n)=>{0===P.length&&($(t).css("display","flex"),$(e).css("display","none"),$(n).text("За покупками"),C.css("overflow-y","hidden"))},D=t=>{t.on("click",(function(){$(x).fadeIn(500),$(w).addClass("basket_active"),document.body.style.overflow="hidden"}))};D(O);const W=t=>{$(t).on("click",(function(){$(x).fadeOut(500),$(w).removeClass("basket_active"),document.body.style.overflow="auto"}))};W($("#order-link")),W(I);const J=t=>{$(".basket__item-del").on("click",(function(){const e=$(this).closest(".basket__item").data("id");P.some((t=>t.productId===e))||t.closest(".catalog__content").find("[data-modal='append']").removeClass("button_catalog_active").text("Добавить в корзину")}))},A=()=>{$(".basket__item-del").on("click",(function(){const t=$(this).closest(".basket__item").attr("data-id");P=P.filter((e=>Number(e.productId)!==Number(t))),localStorage.setItem("selectedProducts",JSON.stringify(P)),E(),$(this).closest(".basket__item").slideUp(250),T($(".basket__items-empty"),$("#order"),$("#order-link"))}))};P.forEach((function(t){const e=`\n    <li data-id=${t.productId} class="basket__item">\n        <picture class="basket__item-img">\n            <source\n                srcset="${t.productImgWebP}"\n                type="image/webp"\n            />\n\n            <img\n                class="basket__item-icon"\n                src="${t.productImg}"\n                alt="pulsometr"\n            />\n        </picture>\n\n        <div class="basket__item-info">\n            <span class="basket__item-info-name">\n                    ${t.productName} \n            </span> \n\n            <span class="basket__item-info-availability">\n              В наличии \n            </span> \n\n            <div class="basket__item-info-wrapper">\n                <div class="basket__item-info-counter">\n                    <span class="basket__item-info-counter-minus">-</span>\n\n                    <span class="basket__item-info-value">\n                        ${t.valueCounter}\n                    </span>\n\n                    <span class="basket__item-info-counter-plus">+</span>\n                </div>\n\n                <span class="basket__item-info-price">\n                    ${t.totalPrice} $\n                </span>\n            </div>\n        </div>\n\n        <span class="basket__item-del">\n            &#x2715; \n        </span> \n    </li>`;C.prepend(e);const n=$(`.catalog__content[data-id="${t.productId}"]`).find("[data-modal='append']");J(n),$(".basket__items-empty").css("display","none")})),T($(".basket__items-empty"),$("#order"),$("#order-link"));const E=()=>{U=P.reduce(((t,e)=>t+e.totalPrice),0),0===U?(N.text("Корзина"),S.text("0 $")):(N.text(`${U} $`),S.text(`${U} $`))};$("[data-modal='append']").each((function(){const t=$(this);(t=>{const e=t.closest(".catalog__content").attr("data-id");P.some((t=>t.productId===e))&&t.addClass("button_catalog_active").text("В корзине")})(t),E(),D(t),t.on("click",(function(){C.css("overflow-y","auto");const e=t.closest(".catalog__content").attr("data-id");if(!P.some((t=>Number(t.productId)===Number(e)))){const e=t.closest(".catalog__content").attr("data-id"),n=t.closest(".catalog__content").find(".catalog__content-img img").attr("src"),s=t.closest(".catalog__content").find(".catalog__content-img source").attr("srcset"),o=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-label").text(),a=t.closest(".catalog__content-wrapper-price").siblings(".catalog__content-description").text().trim(),i=parseInt(t.siblings(".catalog__content-default-price").text()),c=parseInt(t.siblings(".catalog__content-discount-price").text())||i;U+=c,N.text(`${U} $`),S.text(`${U} $`),t.addClass("button_catalog_active").text("В корзине"),P.push({productId:e,productImg:n,productImgWebP:s,productName:o,productDescr:a,totalPrice:c,valueCounter:1}),localStorage.setItem("selectedProducts",JSON.stringify(P));const l=`\n        <li data-id=${e} class="basket__item">\n            <picture class="basket__item-img">\n                <source\n                    srcset="${s}"\n                    type="image/webp"\n                />\n\n                <img\n                    class="basket__item-icon"\n                    src="${n}"\n                    alt="pulsometr"\n                />\n            </picture>\n\n            <div class="basket__item-info">\n                <span class="basket__item-info-name">\n                    ${o} \n                </span> \n\n                <span class="basket__item-info-availability">\n                  В наличии \n                </span> \n\n                <div class="basket__item-info-wrapper">\n                    <div class="basket__item-info-counter">\n                        <span class="basket__item-info-counter-minus">-</span>\n\n                        <span class="basket__item-info-value">1</span>\n\n                        <span class="basket__item-info-counter-plus">+</span>\n                    </div>\n\n                    <span class="basket__item-info-price">${c} $</span>\n                </div>\n            </div>\n\n            <span class="basket__item-del">\n                &#x2715; \n            </span> \n        </li>`;C.prepend(l),D(t),A(),$(".basket__items-empty").css("display","none"),$("#order").css("display","block"),$("#order-link").text("Добавить другие товары"),J(t)}}))})),A()}));
