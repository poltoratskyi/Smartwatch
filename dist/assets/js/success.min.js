$(document).ready((function(){$(".preloader").fadeOut(500);let n=JSON.parse(localStorage.getItem("selectedProducts"))||[],e=JSON.parse(localStorage.getItem("personalInfo"))||[];const t=["personalInfo","selectedProducts"];$("#comeback, #1").click((function(){t.forEach((n=>{localStorage.removeItem(n)}))}));const i=$(".review-items");var s;s=i,n.forEach((function(n){const e=` <li data-id=${n.productId} class="review-item">\n  \n              <picture class="review-item__info-img">\n                  <source\n                      srcset="${n.productImgWebP}"\n                      type="image/webp"\n                  />\n  \n                  <img\n                      class="review-item__info-icon"\n                      src="${n.productImg}"\n                      alt="pulsometr"\n                  />\n              </picture>\n  \n              <div class="review-item__info">\n  \n                  <div class="review-item__info-product">\n                      <span class="review-item__info-product-name">\n                          ${n.productName}\n                      </span>\n                      \n                      <span class="review-item__info-product-quantity">\n                          ${n.valueCounter} шт.\n                      </span>\n                  </div>\n  \n                  <div class="review-item__info-product">\n                      <p class="review-item__info-product-descr">\n                          ${n.productDescr}\n                      </p>\n                  </div>\n  \n                  <div class="review-item__info-product">\n                      <span class="review-item__info-product-total-descr">\n                          Цена\n                      </span>\n  \n                      <span class="review-item__info-product-price">\n                      ${n.productPrice?n.productPrice+" $":n.productDefaultPrice+" $"}\n                      </span>\n                  </div>\n              </div>\n          </li>`;s.prepend(e)}));((n,e)=>{e.forEach((function(e){const t=` \n      <li class="personal-info__content-item">\n        <span>Номер вашего заказа:</span>\n        <span><b>${e.orderNumber}</b></span>\n      </li>\n\n    <li class="personal-info__content-item">\n      <span>Получатель:</span>\n      <span><b> ${e.name}</b></span>\n    </li>\n\n    <li class="personal-info__content-item">\n      <span>Номер телеофона:</span>\n      <span> <b> ${e.phone} </b> </span>\n    </li>\n\n    <li class="personal-info__content-item">\n      <span>Адрес доставки:</span>\n      <span><b> ${e.city}, ${e.address}</b></span>\n    </li>`;n.prepend(t)}))})($(".personal-info__content-items"),e);(e=>{const t=n.reduce(((n,e)=>n+e.totalPrice),0);$(e).text(`${t} $`)})($(".review-total-price")),(n=>{0===n.length&&(window.location.href="order.min.html#to-catalog")})(n&&e)}));
/*!
