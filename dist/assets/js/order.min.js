$(document).ready((function(){$(".preloader").fadeOut(500),$("input[name=phone]").mask("+1(23) 999 999",{autoclear:!1});const e=$(".basket"),t=$(".basket-overlay"),n=$(".basket__items"),s=$("#checkout-basket"),i=$(".basket__title-close"),o=$(".checkout__order-review-items");let c=JSON.parse(localStorage.getItem("selectedProducts"))||[];s.on("click",(function(){$(t).fadeIn(500),$(e).addClass("basket_active"),document.body.style.overflow="hidden"}));(n=>{$(n).on("click",(function(){$(t).fadeOut(500),$(e).removeClass("basket_active"),document.body.style.overflow="auto",c.length>0?setTimeout((()=>{location.reload()}),500):setTimeout((()=>{a(c)}),500)}))})(i);const a=e=>{0===e.length&&(window.location.href="index.min.html#to-catalog")};var r;r=o,c.forEach((function(e){const t=` <li data-id=${e.productId} class="checkout__order-review-item">\n\n            <picture class="checkout__order-review-item-info-img">\n                <source\n                    srcset="${e.productImgWebP}"\n                    type="image/webp"\n                />\n\n                <img\n                    class="checkout__order-review-item-info-icon"\n                    src="${e.productImg}"\n                    alt="pulsometr"\n                />\n            </picture>\n\n            <div class="checkout__order-review-item-info">\n\n                <div class="checkout__order-review-item-info-product">\n                    <span class="checkout__order-review-item-info-product-name">\n                        ${e.productName}\n                    </span>\n                    \n                    <p class="checkout__order-review-item-info-product-quantity">\n                        ${e.valueCounter} шт.\n                    </p>\n                </div>\n\n                <div class="checkout__order-review-item-info-product">\n                    <p class="checkout__order-review-item-info-product-descr">\n                        ${e.productDescr}\n                    </p>\n                </div>\n\n                <div class="checkout__order-review-item-info-product">\n                    <span class="checkout__order-review-item-info-product-total-descr">\n                        Цена\n                    </span>\n\n                    <span class="checkout__order-review-item-info-product-price">\n                        ${e.totalPrice} $\n                    </span>\n                </div>\n            </div>\n        </li>`;r.prepend(t)}));c.forEach((function(e){const t=`\n      <li data-id=${e.productId} class="basket__item">\n          <picture class="basket__item-img">\n              <source\n                  srcset="${e.productImgWebP}"\n                  type="image/webp"\n              />\n  \n              <img\n                  class="basket__item-icon"\n                  src="${e.productImg}"\n                  alt="pulsometr"\n              />\n          </picture>\n  \n          <div class="basket__item-info">\n                <span class="basket__item-info-name">\n                    ${e.productName} \n                </span>\n\n\n                <span class="basket__item-info-availability">\n                    В наличии \n                </span> \n  \n              <div class="basket__item-info-wrapper">\n                  <div class="basket__item-info-counter">\n                      <span class="basket__item-info-counter-minus">-</span>\n  \n                      <span class="basket__item-info-value">\n                          ${e.valueCounter}\n                      </span>\n  \n                      <span class="basket__item-info-counter-plus">+</span>\n                  </div>\n  \n                  <span class="basket__item-info-price">\n                      ${e.totalPrice} $\n                  </span>\n              </div>\n          </div>\n  \n          <span class="basket__item-del">\n              &#x2715; \n          </span> \n      </li>`;n.prepend(t),$(".basket__items-empty").css("display","none")})),$(".basket__item-del").on("click",(function(){const e=$(this).closest(".basket__item").attr("data-id");c=c.filter((t=>Number(t.productId)!==Number(e))),localStorage.setItem("selectedProducts",JSON.stringify(c)),l(),$(this).closest(".basket__item").slideUp(250),setTimeout((()=>{a(c)}),500)})),a(c);const d=$(".checkout__order-review-total-price"),l=e=>{const t=c.reduce(((e,t)=>e+t.totalPrice),0);$(e).text(`${t} $`)};l(d);const u=$(".footer__mobile-info-sidebar-title"),_=$(".footer__mobile-info-sidebar-lists"),p=$(".more-arrow-down");(e=>{e.on("click",(function(){const e=$(this).siblings(_),t=$(this).find(p);e.is(":visible")?(e.slideUp(300),t.css("transform","rotate(315deg)")):(e.slideDown(300),t.css("transform","rotate(135deg)"))}))})(u)}));
