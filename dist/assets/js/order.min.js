$(document).ready((function(){$(".preloader").fadeOut(500),$("input[name=phone]").mask("+380(99) 999 99 99",{autoclear:!1}),$.validator.addMethod("cyrillic",(function(e,t){return this.optional(t)||/^[а-яА-ЯёЁ]+$/i.test(e)}),"Пожалуйста, введите только кириллические символы"),$.validator.addMethod("numberUA",(function(e,t){return this.optional(t)||/^\+380\((?:50|66|95|99|63|67|68|96|97|98|39|73|93)\) \d{3} \d{2} \d{2}$/i.test(e)}),"Пожалуйста, введите корректный номер телефона в формате +380(XX) XXX XX XX"),$.validator.addMethod("emailPublic",(function(e,t){return this.optional(t)||/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(e)}),"Пожалуйста, введите корректный Email"),jQuery.validator.setDefaults({success:"valid"});$("#orderForm").validate({rules:{name:{required:!0,minlength:2,cyrillic:!0},surname:{required:!0,minlength:2,cyrillic:!0},phone:{required:!0,numberUA:!0},email:{required:!0,emailPublic:!0},city:{required:!0,minlength:2,cyrillic:!0},address:{required:!0,minlength:1}},messages:{name:{required:"Пожалуйста, введите ваше имя",minlength:"Имя должно быть не короче двух символов"},surname:{required:"Пожалуйста, введите вашу фамилию",minlength:"Фамилия должна быть не короче двух символов"},phone:{required:"Пожалуйста, введите ваш номер телефона"},email:{required:"Пожалуйста, введите ваш Email",email:"Пожалуйста, введите корректный Email"},city:{required:"Пожалуйста, введите ваш город",minlength:"Название города должно быть не короче двух символов"},address:{required:"Пожалуйста, введите вашу улицу",minlength:"Название вашей улицы должно быть не короче одного символа"}},submitHandler:function(e,t){t.preventDefault();let n=JSON.parse(localStorage.getItem("orderCounter"))||0;n+=1;let i=JSON.parse(localStorage.getItem("personalInfo"))||[];const a={name:$(e).find("input[name='name']").val(),surname:$(e).find("input[name='surname']").val(),phone:$(e).find("input[name='phone']").val(),email:$(e).find("input[name='email']").val(),city:$(e).find("input[name='city']").val(),address:$(e).find("input[name='address']").val(),orderNumber:n};i.push(a),localStorage.setItem("personalInfo",JSON.stringify(i)),localStorage.setItem("orderCounter",JSON.stringify(n)),setTimeout((()=>{$(e).find('input[type="text"], input[type="tel"], input[type="email"]').val(""),window.location.href="success.min.html"}),1e3)}});const e=$(".basket"),t=$(".basket-overlay"),n=$(".basket__items"),i=$("#checkout-basket"),a=$(".basket__title-close"),s=$(".review-items");let o=JSON.parse(localStorage.getItem("selectedProducts"))||[];i.on("click",(function(){$(t).fadeIn(500),$(e).addClass("basket_active"),document.body.style.overflow="hidden"}));(n=>{$(n).on("click",(function(){$(t).fadeOut(500),$(e).removeClass("basket_active"),document.body.style.overflow="auto",o.length>0?setTimeout((()=>{location.reload()}),500):setTimeout((()=>{r(o)}),500)}))})(a);const r=e=>{0===e.length&&(window.location.href="index.min.html#to-catalog")};var c;c=s,o.forEach((function(e){const t=` <li data-id=${e.productId} class="review-item">\n\n            <picture class="review-item__info-img">\n                <source\n                    srcset="${e.productImgWebP}"\n                    type="image/webp"\n                />\n\n                <img\n                    class="review-item__info-icon"\n                    src="${e.productImg}"\n                    alt="pulsometr"\n                />\n            </picture>\n\n            <div class="review-item__info">\n\n                <div class="review-item__info-product">\n                    <span class="review-item__info-product-name">\n                        ${e.productName}\n                    </span>\n                    \n                    <span class="review-item__info-product-quantity">\n                        ${e.valueCounter} шт.\n                    </span>\n                </div>\n\n                <div class="review-item__info-product">\n                    <p class="review-item__info-product-descr">\n                        ${e.productDescr}\n                    </p>\n                </div>\n\n                <div class="review-item__info-product">\n                    <span class="review-item__info-product-total-descr">\n                        Цена\n                    </span>\n\n                    <span class="review-item__info-product-price">\n                    ${e.productPrice?e.productPrice+" $":e.productDefaultPrice+" $"}\n                    </span>\n                </div>\n            </div>\n        </li>`;c.prepend(t)}));o.forEach((function(e){const t=`\n      <li data-id=${e.productId} class="basket__item">\n          <picture class="basket__item-img">\n              <source\n                  srcset="${e.productImgWebP}"\n                  type="image/webp"\n              />\n  \n              <img\n                  class="basket__item-icon"\n                  src="${e.productImg}"\n                  alt="pulsometr"\n              />\n          </picture>\n  \n          <div class="basket__item-info">\n                <span class="basket__item-info-name">\n                    ${e.productName} \n                </span>\n\n\n                <span class="basket__item-info-availability">\n                    В наличии \n                </span> \n  \n              <div class="basket__item-info-wrapper basket__item-info-wrapper_order">\n                  <div class="basket__item-info-counter">\n                        <button data-modal="minus"  class="basket__item-info-counter-minus">\n                            -\n                        </button>\n  \n                        <span class="basket__item-info-value basket__item-info-value_order">\n                            ${e.valueCounter}\n                        </span>\n  \n                        <button data-modal="plus" class="basket__item-info-counter-plus">\n                            +\n                        </button>\n                  </div>\n\n                  <span class="basket__item-info-price">\n                  ${e.totalPrice+" $"}\n                  </span>\n              </div>\n          </div>\n  \n          <span class="basket__item-del">\n              &#x2715; \n          </span> \n      </li>`;n.prepend(t),$(".basket__items-empty").css("display","none")})),$(".basket__item-del").on("click",(function(){const e=$(this).closest(".basket__item").attr("data-id");o=o.filter((t=>Number(t.productId)!==Number(e))),localStorage.setItem("selectedProducts",JSON.stringify(o)),d(),$(this).closest(".basket__item").slideUp(250),setTimeout((()=>{r(o)}),500)})),r(o);$("[data-modal=plus]").each((function(){const e=$(this),t=e.closest(".basket__item").attr("data-id");e.on("click",(function(){const n=o.findIndex((e=>Number(e.productId)===Number(t)));if(n>=0){const t=o[n];t.valueCounter+=1;const i=e.closest(".basket__item-info-counter").siblings(".basket__item-info-price");t.isDiscountPrice?(t.totalPrice+=t.productPrice,i.text(`${t.totalPrice} $`)):(t.totalPrice+=t.productDefaultPrice,i.text(`${t.totalPrice} $`)),e.siblings(".basket__item-info-value").text(t.valueCounter),localStorage.setItem("selectedProducts",JSON.stringify(o))}}))})),$("[data-modal=minus]").each((function(){const e=$(this);e.on("click",(function(){const t=e.closest(".basket__item").attr("data-id"),n=o.findIndex((e=>Number(e.productId)===Number(t)));if(n>=0){const t=o[n];if(t.valueCounter>1){t.valueCounter-=1;const n=e.closest(".basket__item-info-counter").siblings(".basket__item-info-price");t.isDiscountPrice?(t.totalPrice-=t.productPrice,n.text(`${t.totalPrice} $`)):(t.totalPrice-=t.productDefaultPrice,n.text(`${t.totalPrice} $`)),e.siblings(".basket__item-info-value").text(t.valueCounter),localStorage.setItem("selectedProducts",JSON.stringify(o))}}}))}));const l=$(".review-total-price"),d=e=>{const t=o.reduce(((e,t)=>e+t.totalPrice),0);$(e).text(`${t} $`)};d(l);const u=$(".footer__mobile-info-sidebar-title"),m=$(".footer__mobile-info-sidebar-lists"),p=$(".more-arrow-down");(e=>{e.on("click",(function(){const e=$(this).siblings(m),t=$(this).find(p);e.is(":visible")?(e.slideUp(300),t.css("transform","rotate(315deg)")):(e.slideDown(300),t.css("transform","rotate(135deg)"))}))})(u)}));
/*!
